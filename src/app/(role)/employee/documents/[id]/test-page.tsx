...
const TestEmployeeDocumentDetail: React.FC = () => {
    ...
    return (
      <div className="p-6">
        <Card>
          ...
          <div className="mt-4">
            <Button type="primary" href="/employee/documents">
              Back to Documents
            </Button>
          </div>
        </Card>
  ...
  return (
    <div className="p-6">
      <Card>
        <Title level={2}>[EMPLOYEE] {document.title}</Title>
        ...
        <div className="mt-4">
          ...
          <Button>
            Edit (Employee can only edit drafts)
          </Button>
        </div>
      </Card>
    </div>
...
export default TestEmployeeDocumentDetail;