          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 h-12 border-input-border focus:border-input-focus transition-smooth"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={handleInputChange}
                className="pl-10 pr-10 h-12 border-input-border focus:border-input-focus transition-smooth"
                required
              />
              <button
                type="button"
